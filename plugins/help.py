        ...
        try:
            ...
            if user.status == "kicked":
               client.send_message(
                   ...
                   text="Sorry Sir, You are Banned to use me. Contact my [Support ](https://t.me/Gauthambala).",
                   parse_mode="markdown",
	        ...
	        reply_markup=InlineKeyboardMarkup(
                    [
                        [
                           InlineKeyboardButton("Join Updates Channel", url="https://t.me/Pgbgroupbot"),
                           InlineKeyboardButton("Support ", url="https://t.me/Gauthambala")
                      ],
...
def _source_code(client, message):
	...
	reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Creator", url="https://t.me/Gauthambala")
                ],
                [
                    InlineKeyboardButton("Join Updates Channel", url="https://t.me/Pgbgroupbot"),
                    InlineKeyboardButton("Support", url="https://t.me/Gauthambala")
...
def _help(client, message):
    ...
    if update_channel:
        try:
            ...
            client.send_message(
                chat_id=message.chat.id,
                text="Hey use this command in my pm. \nFor more help ask in my [Support](https://t.me/Gauthambala).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
